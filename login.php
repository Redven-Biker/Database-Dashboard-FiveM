...
if(isset($_POST['formconnexion'])) {
   ...
   if(!empty($mailconnect) AND !empty($mdpconnect)) {
      $requser = $bdd->prepare("SELECT * FROM membres_panel WHERE pseudo = ? AND motdepasse = ?");
                ...
                <div class="row">
                    <center>
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-body">
                                    <form style="position:fixed; top:30%; left:40%; width:80%;" method="POST" action=""
                                        class="form login">
                                        <div class="row">
                                            <div class="col-md-3 px-md-1">
                                                <div class="form-group">
                                                    ...
                                                    <button type="submit" value="Login" name="formconnexion"
                                                        class="btn btn-fill btn-primary">Connexion</button>
                                                    <?php
         if(isset($erreur)) {
